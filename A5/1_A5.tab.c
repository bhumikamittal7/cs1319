...
static const yytype_int16 yyrline[] =
{
     ...
     164,   209,   220,   223,   224,   227,   234,   243,   244,   296,
     301,   306,   311,   316,   323,   353,   369,   385,   403,   407,
     423,   441,   445,   476,   502,   528,   556,   560,   595,   628,
     629,   659,   663,   693,   697,   749,   753,   788,   792,   797,
     798,   801,   802,   812,   813,   814,   818,   834,   837,   847,
     886,   920,   943,   946,   967,   973,   980,   981,   984,   985,
     988,   991,   996,  1000,  1006,  1010,  1014,  1020,  1026,  1030,
    1033,  1037,  1045,  1046,  1052,  1053,  1056,  1076,  1100,  1131,
    1138,  1150,  1151,  1154,  1155,  1158,  1171,  1172,  1175,  1176
};
#endif
...
#line 137 "1_A5.y"
                    {
                        ...
                        (yyval.E)->loc->type->type=new symbolType("char");
                        
                        
                    }
#line 1638 "1_A5.tab.c"
    break;
...
#line 165 "1_A5.y"
                { 	
						...
						(yyval.A)->type=(yyvsp[-3].A)->type->type;				
                        ...
                        switch((yyvsp[-1].unaryOp))
                                {	  
										...
										case '&':                                       
												...
												(yyval.A)->Array->type->type=(yyvsp[0].A)->Array->type; 
										...
										case '*':                          
											...
											(yyval.A)->loc=gentemp((yyvsp[0].A)->Array->type->type);
...
#line 2455 "1_A5.tab.c"
    break;

  case 53: /* type_specifier: VOID  */
#line 812 "1_A5.y"
                        {var_type="void";}
#line 2461 "1_A5.tab.c"
    break;

  case 54: /* type_specifier: CHAR  */
#line 813 "1_A5.y"
                        { var_type="char"; }
#line 2467 "1_A5.tab.c"
    break;

  case 55: /* type_specifier: INT  */
#line 814 "1_A5.y"
                        { var_type="int"; }
#line 2473 "1_A5.tab.c"
    break;
...
#line 2493 "1_A5.tab.c"
    break;

  case 57: /* declarator: direct_declarator  */
#line 834 "1_A5.y"
                                    { }
#line 2499 "1_A5.tab.c"
    break;
...
#line 848 "1_A5.y"
						...
						else 
						{
							...
							prev->type =  new symbolType("arr", t, atoi((yyvsp[-1].E)->loc->val.c_str()));     
...
#line 2763 "1_A5.tab.c"
    break;

  case 79: /* block_item_list_opt: %empty  */
#line 1030 "1_A5.y"
                                       { (yyval.S)=new Statement(); }
#line 2769 "1_A5.tab.c"
    break;
...
#line 2787 "1_A5.tab.c"
    break;

  case 82: /* block_item: declaration  */
#line 1045 "1_A5.y"
                         { (yyval.S)=new Statement(); }
#line 2793 "1_A5.tab.c"
    break;
