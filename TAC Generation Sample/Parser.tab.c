...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_list_of_statements = 15,        /* list_of_statements  */
...
static const char *const yytname[] =
{
  ...
  "'+'", "'-'", "'*'", "'/'", "UMINUS", "'='", "';'", "'('", "')'",
  "$accept", "list_of_statements", "statement", "expression", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* list_of_statements: statement  */
#line 34 "Parser.y"
{ printrule("L -> S"); }
#line 1092 "Parser.tab.c"
    break;

  case 3: /* list_of_statements: list_of_statements statement  */
#line 37 "Parser.y"
{ printrule("L -> L S"); }
